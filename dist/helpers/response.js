...
class ApiResponse {
     ...
     */
    static success(res, message, data = null, status = 200, meta = {}) {
        const response = {
            meta: {
                status,
                message,
     ...
     */
    static error(res, message, error = null, status = 500, meta = {}) {
        const response = {
            meta: {
                status,
     ...
     * @param {Object} meta - Additional metadata (optional)
     */
    static validationError(res, message = 'Validation failed', error = null, meta = {}) {
